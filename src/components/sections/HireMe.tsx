...
export default function HireMe({ profile, settings }: HireMeProps) {
    ...
    return (
        <Section id="hire-me" className="scroll-mt-28">
            <motion.div {...fadeUp(0)} className="mx-auto w-full max-w-5xl">
                <div className="card-premium relative overflow-hidden p-6 sm:p-8 md:p-12">
                    <div className="absolute left-0 top-0 h-1 w-full bg-gradient-to-r from-purple-500 via-cyan-500 to-purple-500" />
                    ...
                    <div className="flex flex-col gap-10 lg:flex-row lg:items-center lg:justify-between">
                        ...
                        <div className="flex min-w-[240px] flex-col gap-3">
                            <a
                                href="#contact"
                                className="inline-flex items-center justify-center gap-2 rounded-full bg-gradient-to-r from-purple-600 to-cyan-600 px-7 py-4 text-sm font-semibold text-white shadow-lg shadow-purple-500/20 transition-all hover:scale-[1.02] hover:shadow-[0_0_25px_rgba(112,66,248,0.45)] active:scale-[0.98]"
                            >
                                <Rocket size={17} />
                                Start a Project
                            </a>
                            <a
                                ...
                                className="inline-flex items-center justify-center gap-2 rounded-full border border-white/10 bg-white/5 px-7 py-4 text-sm font-semibold text-white transition-all hover:scale-[1.02] hover:border-purple-500/40 hover:bg-white/10 active:scale-[0.98]"
                            >
                                <Mail size={16} />
                                Send an Email
                            </a>
                            {profile.whatsapp && (
                                <a
                                    ...
                                    target="_blank"
                                    rel="noopener noreferrer"
                                    className="inline-flex items-center justify-center gap-2 rounded-full border border-emerald-500/20 bg-emerald-500/10 px-7 py-4 text-sm font-semibold text-emerald-300 transition-all hover:scale-[1.02] hover:bg-emerald-500/15 active:scale-[0.98]"
                                >
                    ...
                    <div className="mt-8 flex flex-col gap-2 rounded-2xl border border-white/5 bg-black/20 p-4 text-center text-xs text-gray-400 sm:flex-row sm:items-center sm:justify-center sm:text-left">
